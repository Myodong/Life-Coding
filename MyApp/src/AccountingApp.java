...
public class AccountingApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("Divident1 : "+ (12345.0-12345.0*0.3)*0.5);
		System.out.println("Divident2 : "+ (12345.0-12345.0*0.3)*0.3);
		System.out.println("Divident3 : "+ (12345.0-12345.0*0.3)*0.2);
	}
